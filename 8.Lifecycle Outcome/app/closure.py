...
def verify_pilot(
    db: Session, ticket_id: int, proposal_id: int, photo_path: str,
    photo_lat: Optional[float], photo_lon: Optional[float],
) -> PilotValidation:
    ...
    validation = PilotValidation(
        ticket_id=ticket_id, proposal_id=proposal_id, photo_url=photo_path,
